...
def main():
    ...
    if args.mode == 'W':
        ...
        for _ in range(100):
            ...
            ax1.plot(round(model[0][0][0], 5), round(model[0][1][0], 5), round(model[0][2][0], 5), '.')
            ax2.plot(round(model[2][0][0], 3), round(model[2][0][1], 3), round(model[2][0][2], 3), '.')
            ax3.plot(round(model[1][0][0], 5), round(model[1][1][0], 5), round(model[1][2][0], 5), '.')
            B2.append(round(model[3][0][0], 3))
            ax1.set_xlabel('w1[0]'); ax1.set_ylabel('w1[1]'); ax1.set_zlabel('w1[2]')
            ax2.set_xlabel('w2[0]'); ax2.set_ylabel('w2[1]'); ax2.set_zlabel('w2[2]')
            ax3.set_xlabel('b1[0]'); ax3.set_ylabel('b1[1]'); ax3.set_zlabel('b1[2]')
